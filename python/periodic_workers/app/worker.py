...
schedule.every().minute.at(":00").do(aggregate_shelly)
...
schedule.every().hour.at("00:01").do(aggregate_shelly_previous_hour) # 5s in to avoid risk of execution at 59:59
